const iconButtons = {
  editButtonPath: `<svg focusable="false" aria-hidden="true" viewBox="0 0 24 24"
  ...
  deleteButtonPath: `<svg focusable="false" aria-hidden="true" viewBox="0 0 24 24"
  ...
  saveButtonPath: `<svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" 
  xmlns="http://www.w3.org/2000/svg"><path d="M21,20V8.414a1,1,0,0,0-.293-.707L16.293,3.293A1,1,0,0,0,15.586,3H4A1,1,0,0,0,3,4V20a1,1,0,0,0,1,1H20A1,1,0,0,0,21,20ZM9,8h4a1,1,0,0,1,0,2H9A1,1,0,0,1,9,8Zm7,11H8V15a1,1,0,0,1,1-1h6a1,1,0,0,1,1,1Z"/></svg>`,
  addButtonPath: `<svg focusable viewBox="0 0 24 24" aria-hidden="true 
            xmlns="http://www.w3.org/2000/svg"><path d="M12 6V18M18 12H6" stroke="#FFFFFF"
             stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  cancelButtonPath: `<svg focusable="false" aria-hidden="true" viewBox="0 0 32 32"
...
const editIcon = () => {
  ...
  svg.setAttribute("data-testid", "EditIcon");
  svg.setAttribute("aria-label", "fontSize small");
